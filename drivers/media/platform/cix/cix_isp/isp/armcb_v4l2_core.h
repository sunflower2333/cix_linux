...
static int inline armcb_outport_bits_to_idx(u32 bits)
{
...
armcb_v4l2_dev_t *armcb_register_instance(struct platform_device *pdev, struct device *devnode, u32 cam_id);

void armcb_isp_put_frame(uint32_t ctx_id, int stream_type, isp_output_port_t port);
